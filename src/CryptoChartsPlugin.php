...
class CryptoChartsPlugin
{
    ...
    public function setResponse()
    {
        ...
        if (!$this->canRespond) {
            return [
                'name' => 'text',
                'contents' => 'Wrong input. Structure: /command [currency] [compare] [timespan] [theme] Example: /chart ppc , /chart ppc usd , /chart ppc usdt 7d candlestick. Refer to https://cryptohistory.org/ for details',
            ];
        }
    ...
    {
        $parameters = [
            'currency' => 'btc', //can be ltc, ppc, nmc, etc. etc.
            'compare' => 'usd', //can be btc or usdt
            'timespan' => '24h', //can be 1y, 30d, 7d, or 24h
            'theme' => 'dark', //can be candlestick, dark, light, sparkling
        ];
        ...
        if (isset($inputParams[1])) {
            // Common mistake: if compare is usd, let's make it usdt tether
        ...
        //TODO on the fly serving before saving to disk
